package com.bakingo.controller;
...
import com.bakingo.model.Cake;
import com.bakingo.service.CakeService;
...
public class CakeController {
	...
	public String OrderForm(@ModelAttribute("cake") Cake cake) {
		return "placeOrder";
	}
	...
	public String getOrderStatus(@Valid @ModelAttribute("cake") Cake cake, BindingResult result, ModelMap map) {
		...
		map.addAttribute("indianPrice", cake.getPrice() * 85);
